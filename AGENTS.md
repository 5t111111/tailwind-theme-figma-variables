...
- **When implementing new conversion features, always document the specification in this AGENTS.md file first, then implement the code**
- **When modifying existing implementation, always update the specification document accordingly**
...
- Spacing values are grouped together in the `Spacing` namespace for Figma variables
- The base unit is defined by `--spacing` (default: `0.25rem`)
- Spacing scale is generated by multiplying the base unit with predefined multipliers
- Multipliers: `0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 5, 6, 7, 8, 9, 10, 11, 12, 14, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 72, 80, 96`
- Figma variable names are `spacing-{multiplier}` (e.g., `spacing-0`, `spacing-1`, `spacing-px`)
